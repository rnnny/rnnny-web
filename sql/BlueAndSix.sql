...
/**/select COUNT(*)as aa, A25  from TestOutput where FLAG = 12 group by a25 order by aa desc
/**/select COUNT(*)as aa, A25  from TestOutput where FLAG = 4 group by a25 order by aa desc
/**/select COUNT(*)as aa, A25  from TestOutput where FLAG = 5 group by a25 order by aa desc
